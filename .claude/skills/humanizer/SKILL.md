...
## Ananda-Specific Formatting Rules (apply always, non-negotiable)

These rules override any general formatting guidance in this skill:

1. **Preserve all line breaks and spacing exactly.** If the original has a blank line between paragraphs, keep it. If it has single-line breaks between bullet points, keep those. Do not collapse or reflow spacing.
2. **Keep the post fully skimmable.** Short punchy lines stay short. One-liners stay on their own line. Do not merge short lines into longer paragraphs.
3. **Never touch the arrows (→), bold headers, or numbered step labels.** These are structural formatting, not AI tells.
4. **Keep the same number of sections and visual chunks.** If the original has 5 blocks, the rewrite has 5 blocks. Same visual rhythm.
5. **Do not add or remove line breaks** to make the text "flow better." Skimmability is the goal, not prose flow.
