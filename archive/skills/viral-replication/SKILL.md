...
3. Apply Adam Robinson's writing style:
   ...
   - **No stacked 2-3 word fragments.** Never write "No connections. No mentors. No roadmap." — connect related ideas into a flowing sentence: "I had like 0 connections and no mentors, did I mention? no roadmap as well." Single-word punches ("Yup." / "Wait.") are fine — the ban is on consecutive short fragments creating a drum-beat list.
...
resp = requests.post("https://api.kie.ai/api/v1/jobs/createTask",
    ...
    json={"model": "gpt-image-2-image-to-image", "input": {
