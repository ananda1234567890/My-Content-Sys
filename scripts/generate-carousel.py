...
# ============================================================
BRAND_NAME = "ANANDA PARAMANICK"    # Appears on banner
AUTHOR_NAME = "Ananda Paramanick"   # Appears on CTA slide
AUTHOR_ROLE = "YouTube Video Editor" # Appears on CTA slide

# --- BRAND COLORS (RGB) ---
BG = (13, 11, 22)           # #0D0B16 deep dark background
TEXT = (255, 255, 255)      # #FFFFFF white text
ACCENT = (167, 139, 250)    # #A78BFA purple highlight
SUBTLE_GREEN = (30, 20, 60) # Deep purple for decorative circles
BANNER = (76, 29, 149)      # #4C1D95 deep purple banner
WHITE = (255, 255, 255)
GRAY = (156, 163, 175)      # #9CA3AF light gray
LIGHT_CIRCLE = (75, 50, 130) # Muted purple decorative circles
# ============================================================
